...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      fetch(String(process.env.API_URL)+ ":5000/" + "search-product", options)
        .then((response) => {
    ...
    addProduct() {
      ...
      fetch(String(process.env.API_URL) + ":5000/" + "add-product", options)
        .then((response) => {
          return response.json();
        })
        .then((data) => {
          fetch(String(process.env.API_URL) + ":5000/" + "update-image", image_options)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
              ...
              fetch(String(process.env.API_URL) + ":5000/" + "send_mail", email_options)
                .then((response) => {
    ...
    deleteProduct(index) {
      ...
      fetch(String(process.env.API_URL) + ":5000/" + "delete-product", options);
    },
    saveProduct() {
      ...
      fetch(String(process.env.API_URL) + ":5000/" + "update-product", options)
        .then((response) => {
          return response.json();
        })
        .then((data) => {
  ...
  created() {
    fetch(String(process.env.API_URL) + ":5000/" + "get_dashboard")
      .then((response) => {
        // console.log(response);
        return response.json();
      })
