...
export default {
  ...
  methods: {
    ...
    addProduct() {
      ...
      fetch(String(process.env.API_URL) + "add-product", options)
        .then((response) => {
          return response.json();
        })
        .then((data) => {
          fetch(String(process.env.API_URL) + "update-image", image_options)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
    ...
    deleteProduct(index) {
      ...
      fetch(String(process.env.API_URL) + "delete-product", options);
    },
    saveProduct() {
      ...
      fetch(String(process.env.API_URL) + "update-product", options)
        .then((response) => {
          return response.json();
        })
        .then((data) => {
